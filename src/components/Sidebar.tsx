    ...
    return (
        ...
        >
            ...
            >
                ...
                <div style={{ flex: 1 }}>
                    <div style={{ fontSize: '14px', fontWeight: 600, color: '#f1f5f9' }}>Disha</div>
                    <div style={{ fontSize: '12px', color: '#475569' }}>Pro Plan</div>
                </div>
                <Link to="/" style={{ color: '#475569', transition: 'color 0.2s' }}>
                    <LogOut size={16} />
                </Link>
            </div>
        </aside>
