                    ...
                    <div className="relative">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                <div className="flex justify-between items-center px-1">
                                    ...
                                    <span title="Password recovery coming soon" className="text-xs text-[#475569] cursor-not-allowed">Forgot?</span>
                                </div>
                                <Input
                                    id="password"
                                    type="password"
                            ...
                            <Button
                                type="submit"
                                variant="default"
                                className="w-full h-12 bg-[#6366f1] hover:bg-[#4f46e5] text-white transition-all shadow-lg shadow-indigo-500/25"
                                disabled={loading}
                            >
                                {loading ? (
                                    <>
                        ...
                        <div className="text-center mt-8">
                            <p className="text-[#94a3b8] text-sm">
                                ...
                                <Link to="/signup" className="text-[#6366f1] font-semibold hover:underline decoration-2 underline-offset-4">
                                    Create account
                                </Link>
                            </p>
                        </div>
